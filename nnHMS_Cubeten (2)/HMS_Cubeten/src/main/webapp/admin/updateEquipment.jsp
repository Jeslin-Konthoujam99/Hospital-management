...
<body>
    ...
    %>
        ...
        <% while(res.next()){ %>
            <div>
                <h2>Update Equipment Item</h2>
                 <form method="post" action="updateEquipment">
                Equipment ID: <input type="hidden" name="equipmentid" value="<%= res.getInt(1) %>"><%= res.getInt(1) %><br>
                Equipment Name: <input type="text" name="equipmentname" value="<%= res.getString(2) %>"><br>
